...
const VideoHelp = ({ 
  videoId = "_BmU-HChO5Y", // ID de video de YouTube predeterminado
  autoOpen = true,
  ...
  // Efecto para abrir automáticamente el modal al cargar la página
  useEffect(() => {
    if (autoOpen) {
  ...
  return (
    <>
      {/* Botón flotante para abrir el tutorial si está cerrado */}
      {!isOpen && (
