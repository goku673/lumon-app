    ...
    fields: [
      {
        ...
        labelKey: "name",
        dataKey: "flattenedGrades", // Usamos la variable flattenedGrades
...
export const renderField = (field, formData, handlers, dataProviders) => {
  ...
  // Obtener datos dinámicos si están disponibles
  ...
  switch (field.type) {
    case "selector":
      ...
      // Determinar qué manejadores usar según el nombre del campo
